                    ...
                    out.push(
                        new OpenLayers.Layer.OSM(
                            ...
                            'http://tile.openstreetmap.org/${z}/${x}/${y}.png', {
                                attribution: "<a href='http://www.casrit.org' style='color:orange;font-weight:bold;background-color:#FFFFFF' target='_blank'>Casrit</a>\
                ...
                case "mapbox":
                    out.push(
                        new OpenLayers.Layer.XYZ(l.name, [
                            ...
                            wrapDateLine: true,
                            numZoomLevels: 17,
                            attribution: "<a href='http://www.casrit.org' style='color:orange;font-weight:bold;background-color:#FFFFFF' target='_blank'>Powered by Casrit</a>\
                                      using <a href='http://www.openstreetmap.org/' target='_blank'>OpenStreetMap</a> raster"
                        })
                    );
                    break;
                ...
                case "google":
                    ...
                    out.push(
                        new OpenLayers.Layer.Google(
                            ...
                            attribution: "<a href='http://www.casrit.org' style='position:relative;left:-470px;color:orange;font-weight:bold;background-color:#FFFFFF' target='_blank'>Powered by Casrit</a>"}
                        ));
                    break;
            }
        });
